...
package uk.co.modularaudio.util.swing.mvc.combo.idstringandvalue;
...
public class IdStringAndValueComboViewListCellRenderer<A extends IdStringAndValueComboItem<B>, B> implements ComboViewListCellRenderer<A>
{
	@SuppressWarnings("rawtypes")
	private ListCellRenderer defaultRenderer = null;
	
	public IdStringAndValueComboViewListCellRenderer()
	{
		this( new DefaultListCellRenderer() );
	}

	@SuppressWarnings("rawtypes")
	public IdStringAndValueComboViewListCellRenderer( ListCellRenderer defaultRenderer )
	{
