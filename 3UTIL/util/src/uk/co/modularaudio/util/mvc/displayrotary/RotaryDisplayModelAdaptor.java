...
public class RotaryDisplayModelAdaptor implements BoundedRangeModel, ValueChangeListener
{
//	private static Log log = LogFactory.getLog( RotaryDisplayModelAdaptor.class.getName() );

	private final Object source;
	private final RotaryDisplayModel sdm;
	private final RotaryDisplayController sdc;

	private final RotaryIntToFloatConverter sitfc;

	private final ArrayList<ChangeListener> cls = new ArrayList<ChangeListener>();

	private final ChangeEvent changeEvent;

	public RotaryDisplayModelAdaptor( final Object source, final RotaryDisplayModel model, final RotaryDisplayController controller )
	{
		this.source = source;
		this.sdm = model;
		this.sdc = controller;
