...
public class MixdownMeterModel extends SliderDisplayModel
{

	private final static MixdownMeterIntToFloatConverter INT_TO_FLOAT_CONVERTER =
			new MixdownMeterIntToFloatConverter();

	public MixdownMeterModel()
	{
