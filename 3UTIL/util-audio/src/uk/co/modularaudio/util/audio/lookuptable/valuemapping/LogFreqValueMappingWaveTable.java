...
public class LogFreqValueMappingWaveTable extends ValueMappingWaveTable
{

	public LogFreqValueMappingWaveTable( int mapBufferLength, boolean isDecay )
	{
		...
		for( int s = 0 ; s < mapBufferLength ; s++ )
		{
			...
			float mappedValue = NormalisedValuesMapper.logMinMaxMapF( linValue, 0, 22050.0f );
