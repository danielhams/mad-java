...
public class LocklessFloatRingBuffer
{
//	private static Log log = LogFactory.getLog( LocklessRingBuffer.class.getName() );
	...
	public LocklessFloatRingBuffer( DataRate dataRate, int millisCapacity, int numChannels )
			throws UnknownDataRateException
	{
		this( (dataRate.calculateSamplesForLatency( millisCapacity ) * numChannels ) );
	}
			
	public LocklessFloatRingBuffer( int capacity )
	{
