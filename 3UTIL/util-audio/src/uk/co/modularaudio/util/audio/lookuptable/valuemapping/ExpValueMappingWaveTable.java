...
public class ExpValueMappingWaveTable extends ValueMappingWaveTable
{

	public ExpValueMappingWaveTable( int mapBufferLength, boolean isDecay )
	{
		...
		for( int s = 0 ; s < mapBufferLength ; s++ )
		{
			...
			float mappedValue = NormalisedValuesMapper.expMapF( linValue );
