...
public class IOQueueEventCopier implements BufferObjectCopier<IOQueueEvent>
{

	@Override
	public void copyValues( final IOQueueEvent in, final IOQueueEvent out )
	{
		out.U_frameTime = in.U_frameTime;
	...
	@Override
	public IOQueueEvent allocInstance()
	{
		return new IOQueueEvent();
	}
