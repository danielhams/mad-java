...
public class TriangleRawWaveTableGenerator extends RawWaveTableGenerator
{
	...
	public CubicPaddedRawWaveTable reallyGenerateWaveTable( int cycleLength, int numHarmonics )
	{
		...
		{
			harmonics.floatBuffer[i] = 1.0f / ( (i + 1) * (i + 1));
		}
		
		FourierTableGenerator.fillTable( retVal.buffer, 1, retVal.origWaveLength, numHarmonics, harmonics.floatBuffer, 0.0f );
