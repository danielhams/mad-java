...
public class HardwareMidiNoteEventCopier implements BufferObjectCopier<HardwareMidiNoteEvent>
{
	...
	@Override
	public HardwareMidiNoteEvent allocInstance()
	{
		return new HardwareMidiNoteEvent();
	}
