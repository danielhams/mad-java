...
public class ExpFreqValueMappingWaveTable extends ValueMappingWaveTable
{

	public ExpFreqValueMappingWaveTable( int mapBufferLength, boolean isDecay )
	{
		...
		for( int s = 0 ; s < mapBufferLength ; s++ )
		{
			...
			float mappedValue = NormalisedValuesMapper.expMinMaxMapF( linValue, 0.0f, 22050.0f );
