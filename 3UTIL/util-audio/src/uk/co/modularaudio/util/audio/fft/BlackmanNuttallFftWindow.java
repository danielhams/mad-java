...
public class BlackmanNuttallFftWindow extends FftWindow
{
	private final static double A1 = 0.3635819;
	private final static double A2 = 0.4891775;
	private final static double A3 = 0.1365995;
	private final static double A4 = 0.0106411;

	public BlackmanNuttallFftWindow( final int length )
	{
		super( length );
	}
