...
public class MixdownSliderIntToFloatConverter implements SliderIntToFloatConverter
{
//	private static Log log = LogFactory.getLog( MixdownSliderIntToFloatConverter.class.getName() );
	...
	{
		this( DEFAULT_LIN_HIGHEST_DB,
				DEFAULT_LIN_LOWEST_DB,
				DEFAULT_COM_HIGHEST_DB,
				DEFAULT_COM_LOWEST_DB );
	}

	public MixdownSliderIntToFloatConverter( final float linearHighestDb,
