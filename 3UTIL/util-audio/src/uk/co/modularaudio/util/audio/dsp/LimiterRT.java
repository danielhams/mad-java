...
public class LimiterRT
{
	public static Log log = LogFactory.getLog( LimiterRT.class.getName() );
	...
	public LimiterRT( double knee, double falloff )
	{
		this.knee = knee;
	...
	public double limitIt( double[] testVals, int position, int length )
	{
...
//			}
	...
	public float limitIt( float[] testVals, int position, int length )
	{
		for( int i = position ; i < position + length ; i++ )
		{
