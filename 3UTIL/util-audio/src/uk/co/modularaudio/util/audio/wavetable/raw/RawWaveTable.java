...
package uk.co.modularaudio.util.audio.wavetable.raw;
...
public class RawWaveTable implements WaveTable
{
	public float[] floatBuffer = null;
	public int capacity = -1;
	
	public RawWaveTable( float[] dataToUse )
	{
		this( dataToUse.length, false );
		System.arraycopy( dataToUse, 0, floatBuffer, 0, capacity );
	}
	
	public RawWaveTable( int capacity, boolean initialiseToZero )
	{
