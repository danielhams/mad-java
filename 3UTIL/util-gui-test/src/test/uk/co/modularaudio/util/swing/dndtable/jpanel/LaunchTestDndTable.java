...
package test.uk.co.modularaudio.util.swing.dndtable.jpanel;
...
import test.uk.co.modularaudio.util.swing.dndtable.jpanel.pacdndstuff.TestDndRackDecorations;
import test.uk.co.modularaudio.util.swing.dndtable.jpanel.pacdndstuff.TestDndRackDragPolicy;
...
public class LaunchTestDndTable extends JFrame
{
	private static final long serialVersionUID = -2122530652398178239L;
	
	private static Log log = LogFactory.getLog( LaunchTestDndTable.class.getName() );
	...
	public LaunchTestDndTable() throws RecordNotFoundException, DatastoreException
	{
...
//				tableModel.addContentsAtPosition( contentsTwo, 0, 2 );
			...
			JPanelDndTable<TestTC, TestTP, TestGC> testSwingTable = new JPanelDndTable<TestTC, TestTP, TestGC>( tableModel,
					emptyCellPainter,
			...
			TestPopupListener pl = getPopupListener();
			testSwingTable.addMouseListener( pl );
...
//					UIManager.setLookAndFeel( newLookAndFeel );
					...
					LaunchTestDndTable launcher = new LaunchTestDndTable();
