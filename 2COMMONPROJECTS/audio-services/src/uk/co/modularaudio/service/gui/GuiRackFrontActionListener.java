...
public interface GuiRackFrontActionListener
{
	void setRackDataModel( RackDataModel rackDataModel );

	void guiMoveContentsToPosition(RackComponent dragSourceTableComponent, int x, int y) throws TableCellFullException, TableIndexOutOfBoundsException, NoSuchContentsException, DatastoreException;
