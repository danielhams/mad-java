	...
	implements IMadUiControlInstance<SubRackMadDefinition, SubRackMadInstance, SubRackMadUiInstance>
{
	...
	public SubRackSavePatchButtonUiJComponent( final SubRackMadDefinition definition,
	...
	{
		super( LWTCControlConstants.STD_BUTTON_COLOURS, "Save", false );
	...
	public void receiveClick()
	{
		...
		{
			final String msg = "Exception caught attempting to save sub rack: " + e1.toString();
			log.error( msg, e1 );
		}
	}
}
