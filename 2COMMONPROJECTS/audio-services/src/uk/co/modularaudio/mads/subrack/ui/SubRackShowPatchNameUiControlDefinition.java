...
{
	public final static String NAME = "ShowPatchName";
	public final static ControlType TYPE = ControlType.DISPLAY;

	public SubRackShowPatchNameUiControlDefinition( int controlIndex, Rectangle controlBounds )
	{
	...
	{
		return new SubRackShowPatchNameUiControlInstance( instance, uiInstance, this );
	}
}
