...
public class CDFrequencyFilterFrequencySliderUiJComponent
	implements IMadUiControlInstance<CDFrequencyFilterMadDefinition, CDFrequencyFilterMadInstance, CDFrequencyFilterMadUiInstance>
{
	...
	public CDFrequencyFilterFrequencySliderUiJComponent(
			...
			final int controlIndex )
	{
		...
		view.setLabelMinSize( CDFrequencyFilterMadUiDefinition.SLIDER_LABEL_MIN_WIDTH, 30 );
