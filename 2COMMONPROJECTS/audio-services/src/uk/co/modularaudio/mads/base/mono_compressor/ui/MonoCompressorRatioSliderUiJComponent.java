...
public class MonoCompressorRatioSliderUiJComponent extends PacCompressionRatioSlider
	implements IMadUiControlInstance<MonoCompressorMadDefinition, MonoCompressorMadInstance, MonoCompressorMadUiInstance>
{
	private static Log log = LogFactory.getLog( MonoCompressorRatioSliderUiJComponent.class.getName() );

	private static final long serialVersionUID = 2538907435465770032L;

	private final MonoCompressorMadUiInstance uiInstance;

	public MonoCompressorRatioSliderUiJComponent( final MonoCompressorMadDefinition definition,
...
//		this.setBackground( Color.ORANGE );
	...
	{
		uiInstance.sendOneCurveAsFloat( MonoCompressorIOQueueBridge.COMMAND_IN_RATIO, newValue );
	}
