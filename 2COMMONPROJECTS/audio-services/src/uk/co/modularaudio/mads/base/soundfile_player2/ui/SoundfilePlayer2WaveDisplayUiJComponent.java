...
import uk.co.modularaudio.mads.base.soundfile_player2.ui.SoundfilePlayer2ZoomToggleGroupUiJComponent.ZoomLevel;
import uk.co.modularaudio.mads.base.soundfile_player2.ui.rollpainter.SoundfileDisplayBuffer;
import uk.co.modularaudio.mads.base.soundfile_player2.ui.rollpainter.SoundfileDisplayBufferClearer;
import uk.co.modularaudio.mads.base.soundfile_player2.ui.rollpainter.SoundfileDisplaySampleFactory;
...
public class SoundfilePlayer2WaveDisplayUiJComponent extends PacPanel
	...
	AnalysisFillCompletionListener
{
	...
	private static Log log = LogFactory.getLog( SoundfilePlayer2WaveDisplayUiJComponent.class.getName() );
	...
	private float currentZoomMillis = SoundfilePlayer2ZoomToggleGroupUiJComponent.ZoomLevel.ZOOMED_DEFAULT.getMillisForLevel();
	...
	public SoundfilePlayer2WaveDisplayUiJComponent(
			...
			final int controlIndex )
	{
		...
		this.bia = ((SoundfilePlayer2MadUiDefinition)uiInstance.getUiDefinition()).getBufferedImageAllocator();
...
//		log.trace("WaveDisplay paint() called");
		...
		{
			g.setColor( SoundfilePlayer2ColorDefines.WAVE_DISPLAY_BACKGROUND_COLOR );
			g.fillRect(0, 0, displayWidth, displayHeight );
		}
		g.setColor( SoundfilePlayer2ColorDefines.WAVE_DISPLAY_CURRENT_POSITION_COLOUR );
