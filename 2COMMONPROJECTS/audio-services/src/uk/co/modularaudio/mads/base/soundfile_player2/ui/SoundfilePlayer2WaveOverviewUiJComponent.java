...
public class SoundfilePlayer2WaveOverviewUiJComponent extends PacPanel
	...
	SoundfileSampleEventListener, AnalysisFillCompletionListener
{
	...
	private static Log log = LogFactory.getLog( SoundfilePlayer2WaveOverviewUiJComponent.class.getName() );
	...
	public SoundfilePlayer2WaveOverviewUiJComponent(
	...
	public void paintComponent(final Graphics g)
	{
		...
		g.setColor( SoundfilePlayer2ColorDefines.WAVE_DISPLAY_BORDER_COLOR );
		...
		{
			g.setColor( SoundfilePlayer2ColorDefines.WAVE_DISPLAY_WAVE_BG_COLOR );
			g.fillRect( xWaveOffset, WAVE_OVERVIEW_BORDER_PIXELS, lastOverviewWidth, lastOverviewHeight );
			if( internalPercentComplete >= 0 )
			{
				g.setColor( SoundfilePlayer2ColorDefines.WAVE_DISPLAY_WAVE_FG_COLOR );
