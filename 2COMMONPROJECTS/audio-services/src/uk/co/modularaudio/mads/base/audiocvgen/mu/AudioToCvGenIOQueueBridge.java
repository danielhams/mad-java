...
public class AudioToCvGenIOQueueBridge<I extends AudioToCvGenMadInstance<?,I>> extends
		MadLocklessQueueBridge<I>
{
	private static Log log = LogFactory.getLog( AudioToCvGenIOQueueBridge.class.getName() );
