...
public class Bessel4FilterMadDefinition extends AbstractNonConfigurableMadDefinition<Bessel4FilterMadDefinition,Bessel4FilterMadInstance>
{
	...
	public final static String DEFINITION_ID = "bessel4";

	private final static String USER_VISIBLE_NAME = "Bessel4 Filter";

	private final static String CLASS_GROUP = MadClassificationService.SOUND_PROCESSING_GROUP_ID;
	private final static String CLASS_NAME = "Bessel4 Filter";
	private final static String CLASS_DESC = "A Bessel 4 pole frequency filter";
	...
	public Bessel4FilterMadDefinition( final BaseComponentsCreationContext creationContext,
