...
public class StereoAmpMeter extends JPanel
{
	...
	public StereoAmpMeter( final DJEQMadUiInstance uiInstance, final BufferedImageAllocator bia, final boolean showClipBox )
	{
		super();
		setOpaque( false );
...
//		Font f = getFont();
		...
		rightAmpMeter = new AmpMeter( uiInstance, dbToLevelComputer, bia, showClipBox );
