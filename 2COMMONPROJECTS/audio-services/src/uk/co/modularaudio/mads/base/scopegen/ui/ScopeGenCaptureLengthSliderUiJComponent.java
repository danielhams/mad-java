...
public class ScopeGenCaptureLengthSliderUiJComponent<D extends ScopeGenMadDefinition<D, I>,
...
//	private static Log log = LogFactory.getLog( OscilloscopeCaptureLengthSliderUiJComponent.class.getName() );
	...
	public ScopeGenCaptureLengthSliderUiJComponent( final D definition,
			final I instance,
			final U uiInstance,
