...
public class SampleAndHoldMadDefinition extends AbstractNonConfigurableMadDefinition<SampleAndHoldMadDefinition, SampleAndHoldMadInstance>
{
	// Indexes into the channels
	public final static int CONSUMER_CV_IN = 0;
	public final static int CONSUMER_TRIGGER_IN = 1;
