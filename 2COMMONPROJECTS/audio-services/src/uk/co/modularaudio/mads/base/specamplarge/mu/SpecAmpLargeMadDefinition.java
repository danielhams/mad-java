...
public class SpecAmpLargeMadDefinition
	extends SpectralAmpGenMadDefinition<SpecAmpLargeMadDefinition, SpecAmpLargeMadInstance>
	implements BaseMadDefinition
{
	...
	{
		return new SpecAmpLargeMadInstance(
				creationContext,
				instanceName,
				this,
				parameterValues,
