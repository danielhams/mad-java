...
public class InterpTesterImpulseUiJComponent
	extends LWTCButton
	implements IMadUiControlInstance<InterpTesterMadDefinition, InterpTesterMadInstance, InterpTesterMadUiInstance>
{
	...
	public InterpTesterImpulseUiJComponent(
	...
	{
		// Default value
		super( LWTCControlConstants.STD_BUTTON_COLOURS, "Generate Impulse", false );
