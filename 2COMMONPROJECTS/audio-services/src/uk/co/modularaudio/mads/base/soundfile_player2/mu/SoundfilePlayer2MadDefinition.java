...
public class SoundfilePlayer2MadDefinition
	extends AbstractNonConfigurableMadDefinition<SoundfilePlayer2MadDefinition,SoundfilePlayer2MadInstance>
	implements BaseMadDefinition
{
	...
	public static final String DEFINITION_ID = "soundfile_player2";

	private final static String USER_VISIBLE_NAME = "Soundfile Player 2";

	private final static String CLASS_GROUP = MadClassificationService.SOUND_SOURCE_GROUP_ID;
	private final static String CLASS_NAME = "Soundfile Player 2";
	...
	public SoundfilePlayer2MadDefinition( final BaseComponentsCreationContext creationContext,
	...
	{
		return new SoundfilePlayer2MadInstance(
				creationContext,
				instanceName,
				this,
				parameterValues,
