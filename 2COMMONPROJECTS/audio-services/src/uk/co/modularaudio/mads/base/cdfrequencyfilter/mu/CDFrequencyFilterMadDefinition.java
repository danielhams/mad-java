...
public class CDFrequencyFilterMadDefinition extends AbstractNonConfigurableMadDefinition<CDFrequencyFilterMadDefinition,CDFrequencyFilterMadInstance>
{
	...
	public static final String DEFINITION_ID = "cd_frequency_filter";

	private final static String USER_VISIBLE_NAME = "Critically Damped Frequency Filter";

	private final static String CLASS_GROUP = MadClassificationService.SOUND_PROCESSING_GROUP_ID;
	private final static String CLASS_NAME = "Critically Damped Frequency Filter";
	private final static String CLASS_DESC = "A filter to remove or allow frequencies that is critically damped";
	...
	public CDFrequencyFilterMadDefinition( final BaseComponentsCreationContext creationContext,
			final MadClassificationService classificationService ) throws RecordNotFoundException, DatastoreException
	{
		super( DEFINITION_ID, USER_VISIBLE_NAME,
				...
				new CDFrequencyFilterIOQueueBridge(),
				NUM_CHANNELS,
				CHAN_NAMES,
				CHAN_TYPES,
				CHAN_DIRS,
