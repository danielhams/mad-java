...
public class PatternSequencerBpmInputValueUiJComponent extends PacFloatSlider
...
//	private static Log log = LogFactory.getLog( PatternSequencerBpmInputValueUiJComponent.class.getName() );
	
	private PatternSequencerMadUiInstance uiInstance = null;

	public PatternSequencerBpmInputValueUiJComponent( PatternSequencerMadDefinition definition,
...
//		this.setMaximum( 20000 );
	...
	private void passChangeToInstanceData( double value )
	{
		...
		uiInstance.sendBpmChange( floatValue );
	}
