...
//	private static Log log = LogFactory.getLog( AttenuationMeterAndLabels.class.getName() );
	...
	public AttenuationMeterAndLabels( final StereoCompressorMadUiInstance uiInstance, final BufferedImageAllocator bia )
	{
		setOpaque( false );
...
//		Font f = getFont();
		...
		final DbToLevelComputer dbToLevelComputer = new AttenuationMeterDbToLevelComputer( METER_NUM_STEPS );
	...
	{
		attenuationMeter.receiveMeterReadingInDb( currentFrameTime, meterReadingDb );
	}
