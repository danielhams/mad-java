...
public class DjEQ2LaneStereoAmpMeter extends JPanel
{
	private static final long serialVersionUID = 1358562457507980606L;

	private static Log log = LogFactory.getLog( DjEQ2LaneStereoAmpMeter.class.getName() );

	private final DPAmpMeter leftMeter;
	private final AmpMeterMarks meterMarks;
	private final DPAmpMeter rightMeter;

	public DjEQ2LaneStereoAmpMeter( final DJEQ2MadUiInstance uiInstance, final BufferedImageAllocator bia, final boolean showClipBox )
	{
		super();
		setOpaque( false );
