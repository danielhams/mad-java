...
public class SoundfilePlayer2DesiredBpmDialUiJComponent
...
{
	private static Log log = LogFactory.getLog( SoundfilePlayer2DesiredBpmDialUiJComponent.class.getName() );
			...
			final int controlIndex )
	{
		...
		model.addChangeListener( new ValueChangeListener()
		{
			...
			{
				uiInstance.setDesiredBpm( newValue );
			}
		} );
