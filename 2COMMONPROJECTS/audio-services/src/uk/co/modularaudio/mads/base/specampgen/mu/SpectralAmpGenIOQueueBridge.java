...
public class SpectralAmpGenIOQueueBridge<I extends SpectralAmpGenMadInstance<?,I>>
	extends MadLocklessQueueBridge<I>
{
	private static Log log = LogFactory.getLog( SpectralAmpGenIOQueueBridge.class.getName() );

	public static final int COMMAND_IN_ACTIVE = 0;
	public static final int COMMAND_OUT_RINGBUFFER_WRITE_INDEX = 1;

	public SpectralAmpGenIOQueueBridge()
	{
	}
