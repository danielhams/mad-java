	...
	extends AbstractNonConfigurableMadUiDefinition<ControllerToCvMadDefinition, ControllerToCvMadInstance, ControllerToCvMadUiInstance>
{
	...
	private static final Class<ControllerToCvMadUiInstance> instanceClass = ControllerToCvMadUiInstance.class;

	public ControllerToCvMadUiDefinition( BufferedImageAllocator bia,
			ControllerToCvMadDefinition definition, ComponentImageFactory cif, String imageRoot )
