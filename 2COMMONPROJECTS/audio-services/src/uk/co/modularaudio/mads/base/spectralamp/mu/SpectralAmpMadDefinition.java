...
public class SpectralAmpMadDefinition extends AbstractNonConfigurableMadDefinition<SpectralAmpMadDefinition,SpectralAmpMadInstance>
{
	...
	private final static String userVisibleName = "Spectral Amp";

	private final static String classificationGroup = MadClassificationService.SOUND_ANALYSIS_GROUP_ID;
	private final static String classificationName = "Spectral Amp";
	private final static String classificationDescription = "A spectral amplitude display";
	...
	public SpectralAmpMadDefinition( BaseComponentsCreationContext creationContext,
