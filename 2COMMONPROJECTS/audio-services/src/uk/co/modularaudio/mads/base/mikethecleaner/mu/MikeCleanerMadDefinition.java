...
public class MikeCleanerMadDefinition extends AbstractNonConfigurableMadDefinition<MikeCleanerMadDefinition,MikeCleanerMadInstance>
{
	// Indexes into the channels
	public final static int CONSUMER_AUDIO_IN= 0;
	public final static int PRODUCER_AUDIO_OUT = 1;
	public final static int NUM_CHANNELS = 2;

	private final static String definitionId = "mike_cleaner";

	private final static String userVisibleName = "Microphone Cleaner";

	private final static String classificationGroup = MadClassificationService.SOUND_PROCESSING_GROUP_ID;
	private final static String classificationId = "mike_cleaner";
	private final static String classificationName = "Simple threshold microphone signal cleaner";
	private final static String classificationDescription = "Reduce noise on a microphone (poorly)";
	...
	public MikeCleanerMadDefinition( BaseComponentsCreationContext creationContext,
