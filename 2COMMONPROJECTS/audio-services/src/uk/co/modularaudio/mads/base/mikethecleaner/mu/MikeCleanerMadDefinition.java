...
public class MikeCleanerMadDefinition extends AbstractNonConfigurableMadDefinition<MikeCleanerMadDefinition,MikeCleanerMadInstance>
{
	...
	private final static String DEFINITION_ID = "mike_cleaner";

	private final static String USER_VISIBLE_NAME = "Microphone Cleaner";

	private final static String CLASS_GROUP = MadClassificationService.SOUND_PROCESSING_GROUP_ID;
	private final static String CLASS_NAME = "Simple threshold microphone signal cleaner";
	private final static String CLASS_DESC = "Reduce noise on a microphone (poorly)";
	...
	public MikeCleanerMadDefinition( final BaseComponentsCreationContext creationContext,
