...
public class NTSpectralAmpPeakDisplayUiJComponent
{
	private static Log log = LogFactory.getLog( NTSpectralAmpPeakDisplayUiJComponent.class.getName() );
	...
	public NTSpectralAmpPeakDisplayUiJComponent( final Component parent, final int canvasWidth, final int canvasHeight, final SpectralAmpMadUiInstance uiInstance )
	{
