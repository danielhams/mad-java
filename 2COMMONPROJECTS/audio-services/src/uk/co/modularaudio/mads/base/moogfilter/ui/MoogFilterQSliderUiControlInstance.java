...
public class MoogFilterQSliderUiControlInstance extends PacLogSlider
	implements IMadUiControlInstance<MoogFilterMadDefinition, MoogFilterMadInstance, MoogFilterMadUiInstance>
{
	private static Log log = LogFactory.getLog( MoogFilterQSliderUiControlInstance.class.getName() );
	
	private static final long serialVersionUID = 6068897521037173787L;

	private MoogFilterMadUiInstance uiInstance = null;

	public MoogFilterQSliderUiControlInstance(
			MoogFilterMadDefinition definition,
			MoogFilterMadInstance instance,
			MoogFilterMadUiInstance uiInstance,
			int controlIndex )
	{
		super( 0.1f, 10.0f, 1.0f, SatelliteOrientation.LEFT, DisplayOrientation.HORIZONTAL, SatelliteOrientation.RIGHT, "Q:",
				Color.BLACK,
				"",
				Color.BLACK,
				false );
