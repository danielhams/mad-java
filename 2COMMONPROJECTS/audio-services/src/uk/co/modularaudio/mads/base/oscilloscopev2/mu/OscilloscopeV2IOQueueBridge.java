...
public class OscilloscopeV2IOQueueBridge extends MadLocklessQueueBridge<OscilloscopeV2MadInstance>
{
	private static Log log = LogFactory.getLog( OscilloscopeV2IOQueueBridge.class.getName() );

	public static final int COMMAND_IN_ACTIVE = 0;
	public static final int COMMAND_IN_CAPTURE_MILLIS = 1;

	public OscilloscopeV2IOQueueBridge()
	{
	}

	@Override
	public void receiveQueuedEventsToInstance( OscilloscopeV2MadInstance instance, ThreadSpecificTemporaryEventStorage tses, long periodTimestamp, IOQueueEvent queueEntry )
	{
