...
public class AmpMeterLevelMarks extends JComponent
{
...
//	public final static int METER_LABEL_WIDTH = 40;
	...
	public AmpMeterLevelMarks( final DbToLevelComputer dbToLevelComputer, final boolean showClipbox, final Font f )
	{
...
//		g.fillRect( 0, 0, width, height );
		...
		final int heightForMarks = height - (2 * METER_LABEL_NEEDED_TOP_BOTTOM_INSET_PIXELS) - ( showClipBox ? AmpMeter.PREFERRED_WIDTH : 0 );
