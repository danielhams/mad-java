...
public class CDFrequencyFilterMadInstance extends MadInstance<CDFrequencyFilterMadDefinition,CDFrequencyFilterMadInstance>
{
//	private static Log log = LogFactory.getLog( FrequencyFilterMadInstance.class.getName() );
	...
	private final CDButterworthFilter24DB leftChannel24db = new CDButterworthFilter24DB();
	private final CDButterworthFilter24DB rightChannel24db = new CDButterworthFilter24DB();

	public CDFrequencyFilterMadInstance( final BaseComponentsCreationContext creationContext,
