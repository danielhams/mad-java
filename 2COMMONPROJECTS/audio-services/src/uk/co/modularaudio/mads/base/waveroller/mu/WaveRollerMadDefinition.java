...
public class WaveRollerMadDefinition
	extends AbstractNonConfigurableMadDefinition<WaveRollerMadDefinition,WaveRollerMadInstance>
	implements BaseMadDefinition
{
	...
	{
		return new WaveRollerMadInstance(
				creationContext,
				instanceName,
				this,
				parameterValues,
