...
import uk.co.modularaudio.mads.base.scopen.ui.display.ScopeAmpLabels;
import uk.co.modularaudio.mads.base.scopen.ui.display.ScopeAmpMarks;
import uk.co.modularaudio.mads.base.scopen.ui.display.ScopeBottomSignalToggles;
import uk.co.modularaudio.mads.base.scopen.ui.display.ScopeEmptyPlot;
import uk.co.modularaudio.mads.base.scopen.ui.display.ScopeTimeLabels;
import uk.co.modularaudio.mads.base.scopen.ui.display.ScopeTimeMarks;
import uk.co.modularaudio.mads.base.scopen.ui.display.ScopeTopPanel;
...
public class ScopeNDisplayUiJComponent<D extends ScopeNMadDefinition<D, I>,
	...
	implements IMadUiControlInstance<D, I, U>, ToggleReceiver, ScopeImageSaver
{
	...
	private static Log log = LogFactory.getLog( ScopeNDisplayUiJComponent.class.getName() );
