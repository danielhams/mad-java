...
public class CPTMadDefinition extends AbstractNonConfigurableMadDefinition<CPTMadDefinition, CPTMadInstance>
{
	...
	public static final String DEFINITION_ID = "cpt";

	private final static String USER_VISIBLE_NAME = "Control Processing Tester";

	private final static String CLASS_GROUP = MadClassificationService.SOUND_ROUTING_GROUP_ID;
	private final static String CLASS_NAME = "Control Processing Tester";
	private final static String CLASS_DESC = "A tester of control processing";
	...
	public CPTMadDefinition( final BaseComponentsCreationContext creationContext,
