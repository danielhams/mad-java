...
public class DJEQMadDefinition
	extends AbstractNonConfigurableMadDefinition<DJEQMadDefinition, DJEQMadInstance>
	implements BaseMadDefinition
{
	...
	public static final String DEFINITION_ID = "djeq";

	private final static String USER_VISIBLE_NAME = "DJ EQ";

	private final static String CLASS_GROUP = MadClassificationService.SOUND_PROCESSING_GROUP_ID;
	private final static String CLASS_NAME = "DJ EQ";
	...
	public DJEQMadDefinition( final BaseComponentsCreationContext creationContext,
