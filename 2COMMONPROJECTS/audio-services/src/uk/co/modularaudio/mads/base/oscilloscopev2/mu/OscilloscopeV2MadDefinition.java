...
public class OscilloscopeV2MadDefinition extends AbstractNonConfigurableMadDefinition<OscilloscopeV2MadDefinition,OscilloscopeV2MadInstance>
{
	// Indexes into the channels
	public final static int CONSUMER_AUDIO_SIGNAL0 = 0;
	public final static int CONSUMER_CV_SIGNAL0 = 1;
	public final static int CONSUMER_AUDIO_SIGNAL1 = 2;
	public final static int CONSUMER_CV_SIGNAL1 = 3;
	public final static int NUM_CHANNELS = 4;

	private final static String definitionId = "oscilloscopev2";

	private final static String userVisibleName = "Oscilloscope V2";

	private final static String classificationGroup = MadClassificationService.SOUND_ANALYSIS_GROUP_ID;
	private final static String classificationId = "oscilloscopev2";
	private final static String classificationName = "Oscilloscope V2";
	...
	public OscilloscopeV2MadDefinition( BaseComponentsCreationContext creationContext,
			MadClassificationService classificationService ) throws RecordNotFoundException, DatastoreException
	{
		super( definitionId, userVisibleName,
				new MadClassification( classificationService.findGroupById( classificationGroup ),
						...
						ReleaseState.ALPHA ),
				new OscilloscopeV2IOQueueBridge(),
				NUM_CHANNELS,
				channelNames,
				channelTypes,
				channelDirections,
