...
import uk.co.modularaudio.util.audio.mvc.displayslider.models.CompressionReleaseSliderModel;
...
public class StereoCompressorReleaseSliderUiJComponent
...
//	private static Log log = LogFactory.getLog( StereoCompressorReleaseSliderUiJComponent.class.getName() );
	...
	{
		model = new CompressionReleaseSliderModel();
		...
		model.addChangeListener( new ValueChangeListener()
		{
			...
			{
				uiInstance.sendRelease( newValue );
			}
		} );
	}
