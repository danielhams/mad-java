...
public class SpectralRollerIOQueueBridge extends MadLocklessQueueBridge<SpectralRollerMadInstance>
{
	private static Log log = LogFactory.getLog( SpectralRollerIOQueueBridge.class.getName() );

	public static final int COMMAND_OUT_RINGBUFFER_WRITE_INDEX = 0;
	public static final int COMMAND_IN_ACTIVE = 1;

	public SpectralRollerIOQueueBridge()
	{
	}

	@Override
	public void receiveQueuedEventsToInstance( final SpectralRollerMadInstance instance,
