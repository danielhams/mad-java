...
public class OutSignalAmpMeterLevelMarks extends JComponent
{
	...
	public OutSignalAmpMeterLevelMarks( final DbToLevelComputer dbToLevelComputer, final boolean showClipbox, final Font f )
	{
...
//		g.fillRect( 0, 0, width, height );
		...
		final int heightForMarks = height - (2 * METER_LABEL_NEEDED_TOP_BOTTOM_INSET_PIXELS) - ( showClipBox ? OutSignalAmpMeter.PREFERRED_WIDTH : 0 );
