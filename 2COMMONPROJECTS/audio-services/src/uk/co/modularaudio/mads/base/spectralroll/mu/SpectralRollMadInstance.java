...
public class SpectralRollMadInstance extends MadInstance<SpectralRollMadDefinition,SpectralRollMadInstance>
{
	private static Log log = LogFactory.getLog( SpectralRollMadInstance.class.getName() );
	...
	public SpectralRollMadInstance( BaseComponentsCreationContext creationContext,
			String instanceName,
			SpectralRollMadDefinition definition,
	...
	public RealtimeMethodReturnCodeEnum process( ThreadSpecificTemporaryEventStorage tempQueueEntryStorage,
			...
			int numFrames )
	{
		boolean inConnected = channelConnectedFlags.get( SpectralRollMadDefinition.CONSUMER_IN);
		MadChannelBuffer inCb = channelBuffers[ SpectralRollMadDefinition.CONSUMER_IN ];
			...
			long frameTime )
	{
		...
		localBridge.queueTemporalEventToUi( tses,
			frameTime,
			SpectralRollIOQueueBridge.COMMAND_OUT_RINGBUFFER_WRITE_INDEX,
			joinedParts, 
			null );
	}
