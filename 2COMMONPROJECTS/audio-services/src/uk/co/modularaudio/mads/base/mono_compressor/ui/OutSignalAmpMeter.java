...
public class OutSignalAmpMeter extends PacPanel
{
	...
	public OutSignalAmpMeter( final MonoCompressorMadUiInstance uiInstance,
			final DbToLevelComputer dbToLevelComputer, final BufferedImageAllocator bia, final boolean showClipBox )
	{
		...
		greenThresholdLevel = calcLevelValueFromDb( GREEN_THRESHOLD_DB );
		orangeThreholdLevel = calcLevelValueFromDb( ORANGE_THRESHOLD_DB );
