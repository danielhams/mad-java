...
public class FeedbackLinkProducerMadDefinition
	extends AbstractNonConfigurableMadDefinition<FeedbackLinkProducerMadDefinition, FeedbackLinkProducerMadInstance>
	implements InternalMadDefinition
{
	// Indexes into the channels
	public final static int PRODUCER_AUDIO = 0;
	...
	{
		return new FeedbackLinkProducerMadInstance(
				creationContext,
				instanceName,
				this,
				parameterValues,
