...
public class FeedbackLinkProducerMadUiDefinition extends MadUiDefinition<FeedbackLinkProducerMadDefinition, FeedbackLinkProducerMadInstance>
{
	...
	@Override
	public MadUiInstance<?,?> createNewUiInstance( final FeedbackLinkProducerMadInstance instance )
		throws DatastoreException
	{
		try
		{
			...
			final MadUiInstance<?,?> retVal = new FeedbackLinkProducerMadUiInstance( instance,
					this );
