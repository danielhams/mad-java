...
public class FeedbackLinkConsumerMadDefinition extends AbstractNonConfigurableMadDefinition<FeedbackLinkConsumerMadDefinition, FeedbackLinkConsumerMadInstance>
{
	...
	public final static String DEFINITION_ID = "feedback_link_consumer";

	private final static String USER_VISIBLE_NAME = "Feedback Link Consumer";

	private final static String CLASS_GROUP = MadClassificationService.INTERNAL_GROUP_ID;
	private final static String CLASS_NAME = "Feedback Link Consumer";
	private final static String CLASS_DESC = "Internal component used in implementing cyclic loops in the audio graph";

	// These must match the channel indexes given above
	private final static String[] CHAN_NAMES = new String[] { "Input Wave", "Input Dependency" };
