...
public class FadeInMadUiDefinition extends MadUiDefinition<FadeInMadDefinition, FadeInMadInstance>
{
	...
	public FadeInMadUiDefinition( final FadeInMadDefinition definition )
	...
	@Override
	public FadeInMadUiInstance createNewUiInstance( final FadeInMadInstance instance )
		throws DatastoreException
	{
		try
		{
			...
			final FadeInMadUiInstance retVal = new FadeInMadUiInstance( instance,
					this );
