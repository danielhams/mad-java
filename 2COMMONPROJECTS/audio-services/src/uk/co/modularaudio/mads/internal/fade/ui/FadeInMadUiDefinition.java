...
public class FadeInMadUiDefinition extends MadUiDefinition<FadeInMadDefinition, FadeInMadInstance>
{
	...
	public FadeInMadUiDefinition( BufferedImageAllocator bia, FadeInMadDefinition definition,
	...
	@Override
	public MadUiInstance<?,?> createNewUiInstance( FadeInMadInstance instance )
		throws DatastoreException
	{
		...
		try
		{
			...
			MadChannelInstance consumerChannelInstance = channelInstances[ FadeInMadDefinition.CONSUMER ];
			uiChannelInstances.add(  new MadUiChannelInstance( CONSUMER_CHANNEL_CENTER, consumerChannelInstance ) );
			MadChannelInstance producerChannelInstance = channelInstances[ FadeInMadDefinition.PRODUCER ];
			...
			retVal = new FadeInMadUiInstance( instance,
					this );
