...
public class FadeOutMadDefinition
	extends AbstractNonConfigurableMadDefinition<FadeOutMadDefinition, FadeOutMadInstance>
	implements InternalMadDefinition
{
	...
	private final static String USER_VISIBLE_NAME = "Fade Out";

	private final static String CLASS_GROUP = MadClassificationService.INTERNAL_GROUP_ID;
	private final static String CLASS_NAME = "Fade out";
	private final static String CLASS_DESC = "Fade out a source source.";
	...
	public FadeOutMadDefinition( final InternalComponentsCreationContext creationContext,
		...
		throws RecordNotFoundException, DatastoreException
	{
		super( DEFINITION_ID, USER_VISIBLE_NAME,
				...
				new MadNullLocklessQueueBridge<FadeOutMadInstance>(),
				NUM_CHANNELS,
				CHAN_NAMES,
				CHAN_TYPES,
				CHAN_DIRS,
