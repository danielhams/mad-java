...
public class TestCreateCPT extends TestCase
{
	private final GenericComponentVisualiser gcv;

	public TestCreateCPT() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException
	{
	...
	public void testAndShowComponent()
			throws Exception
	{
		gcv.testAndShowComponent( CPTMadDefinition.DEFINITION_ID );
	}
}
