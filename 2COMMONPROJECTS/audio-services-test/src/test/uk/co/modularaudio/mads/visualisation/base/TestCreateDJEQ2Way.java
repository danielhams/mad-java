...
public class TestCreateDJEQ2Way
{
	private final GenericComponentVisualiser gcv;

	public TestCreateDJEQ2Way() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException
	{
	...
	{
		gcv.setUp();
		gcv.testAndShowComponent( DJEQ2MadDefinition.DEFINITION_ID );
		gcv.tearDown();
	}

	public static void main( final String[] args ) throws Exception
	{
		final TestCreateDJEQ2Way tc = new TestCreateDJEQ2Way();
		tc.go();
	}
}
