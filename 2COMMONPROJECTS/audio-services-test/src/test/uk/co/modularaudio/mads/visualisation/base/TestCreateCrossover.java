...
public class TestCreateCrossover
{
	private final GenericComponentVisualiser gcv;

	public TestCreateCrossover() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException
	{
	...
	{
		gcv.setUp();
		gcv.testAndShowComponent( CrossoverMadDefinition.DEFINITION_ID );
		gcv.tearDown();
	}

	public static void main( final String[] args ) throws Exception
	{
		final TestCreateCrossover tc = new TestCreateCrossover();
		tc.go();
	}
}
