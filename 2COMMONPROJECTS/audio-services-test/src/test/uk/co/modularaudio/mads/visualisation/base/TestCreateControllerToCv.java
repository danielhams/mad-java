...
public class TestCreateControllerToCv
{
	private final GenericComponentVisualiser gcv;

	public TestCreateControllerToCv() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException
	{
	...
	{
		gcv.setUp();
		gcv.testAndShowComponent( ControllerToCvMadDefinition.DEFINITION_ID );
		gcv.tearDown();
	}

	public static void main( final String[] args ) throws Exception
	{
		final TestCreateControllerToCv tc = new TestCreateControllerToCv();
		tc.go();
	}
}
