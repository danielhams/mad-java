...
public class TestCreateScope
{
	private final GenericComponentVisualiser gcv;

	public TestCreateScope() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException
	{
	...
	{
		gcv.setUp();
		gcv.testAndShowComponent( ScopeMadDefinition.DEFINITION_ID );
		gcv.tearDown();
	}

	public static void main( final String[] args ) throws Exception
	{
		final TestCreateScope tc = new TestCreateScope();
		tc.go();
	}
}
